export async function onRequest(context) {
  ...
  const isProtected =
    ...
    url.pathname.startsWith('/organon-stock-analysis');
  if (!isProtected) {
    return next();
  }
...
function renderOrganonForm(error) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Organon Analysis — Si</title>
...
<body>
  <div class="wrap">
    <div class="heading">
      <h1>Organon</h1>
      <p class="sub">Under review</p>
    </div>
    <p class="note">This analysis is currently in audit. Access requires author authorization.</p>
    ...
    <div style="width:100%;display:flex;flex-direction:column;gap:0.9rem;">
      ...
      <a class="email-btn" href="mailto:sisi.zhang.ch@gmail.com">Request access</a>
    </div>
  </div>
</body>
</html>`;
